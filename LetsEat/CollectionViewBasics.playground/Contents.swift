...
class CollectionViewExampleController: UIViewController {
  ...
  func createCollectionView() {
    ...
    frame: CGRect(x:0, y:0, width: self.view.frame.width, height: self.view.frame.height), collectionViewLayout: UICollectionViewFlowLayout())
...
extension CollectionViewExampleController: UICollectionViewDataSource {
